...
Spark.prototype = {
  ...
  init: function () {
    ...
    this.angle = (Math.random() * -60 * Math.PI) / 180;
    ...
    var multiplier = 950 + Math.random() * 800;
    ...
    this.x = this.dx - 5 - 4 * Math.random();
    this.y = this.dy + 3.5 * Math.random();
  },
...
// Инициализация WebGL
var canvas = document.getElementById("glCanvasEight");
