...
Spark.prototype = {
  ...
  init: function () {
    ...
    this.angle = ((Math.random() * 20 + 80) * Math.PI) / 180;
    ...
    var multiplier = 750 + Math.random() * 1000;
    ...
    this.x = this.dx + (5 - 10 * Math.random());
    this.y = this.dy + 0.1 * Math.random();
  },
